...
namespace yesmarket.Messaging.Msmq
{
        ...
        where TFormatter : IMessageFormatter
    {
        public MessageQueueImpl()
        {
            Formatter = (TFormatter) Activator.CreateInstance(typeof (TFormatter));
        }

        public MessageQueueImpl(TFormatter formatter)
        {
            Formatter = formatter;
        }
        ...
        public MessageQueueImpl(string path, TFormatter formatter)
            : base(path)
        {
            Formatter = formatter;
        }
        ...
        public MessageQueueImpl(string path, QueueAccessMode accessMode, TFormatter formatter)
            : base(path, accessMode)
        {
            Formatter = formatter;
        }
        ...
        public MessageQueueImpl(string path, bool sharedModeDenyReceive, TFormatter formatter)
            : base(path, sharedModeDenyReceive)
        {
            Formatter = formatter;
        }
        ...
        public MessageQueueImpl(string path, bool sharedModeDenyReceive, bool enableCache, TFormatter formatter)
            : base(path, sharedModeDenyReceive, enableCache)
        {
            Formatter = formatter;
        }
